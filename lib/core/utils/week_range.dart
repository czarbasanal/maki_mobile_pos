/// Week-to-date helpers.
///
/// The app uses a Monday→Sunday work week. These helpers are pure (take
/// the reference [DateTime] explicitly) so they're trivially unit-testable
