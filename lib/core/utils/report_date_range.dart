...
/// Start is midnight; end is true end-of-day (23:59:59.999) of the last day
/// so an inclusive `<=` query never drops a record created in the final
/// second of the day. Callers never pass [DateRangePreset.custom] (the
/// picker routes custom selections to its own date-range picker via
/// onCustomRangeSelected); it falls back to today.
DateTimeRange dateRangeForPreset(DateRangePreset preset, DateTime now) {
  ...
  switch (preset) {
    ...
    case DateRangePreset.lastWeek:
      ...
      end = DateTime(lwe.year, lwe.month, lwe.day, 23, 59, 59, 999);
      break;
