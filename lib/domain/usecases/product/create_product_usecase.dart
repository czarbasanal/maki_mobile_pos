...
///
/// Callers supply a fully-formed product entity with a resolved numeric cost.
/// Staff enter a cost CODE in the inventory form, which is decoded to the cost
/// there before this use case runs; the receiving batch importer supplies the
/// cost from its CSV. This keeps the use case agnostic to how cost was sourced.
