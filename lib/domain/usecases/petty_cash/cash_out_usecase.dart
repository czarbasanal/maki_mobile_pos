...
/// Withdraws cash from the petty-cash fund. Permission: [Permission.managePettyCash].
class CashOutUseCase {
  ...
  Future<UseCaseResult<PettyCashEntity>> execute({
    ...
    try {
      ...
      final record = await _repository.cashOut(
        amount: amount,
      ...
      await _logger.log(
        ...
        metadata: {'amount': amount, 'direction': 'out'},
      );
      ...
      return UseCaseResult.failure(message: 'Failed to record cash out: $e');
    }
  }
}
