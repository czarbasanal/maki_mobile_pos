...
/// Data model for Job Order with Firestore serialization.
///
/// This model handles:
...
class JobOrderModel {
  ...
  factory JobOrderModel.fromMap(Map<String, dynamic> map, String documentId) {
    // Parse items array
    ...
    return JobOrderModel(
      id: documentId,
      name: map['name'] as String? ?? 'Unnamed Job Order',
      items: itemsList,
  ...
  factory JobOrderModel.fromFirestore(
      DocumentSnapshot<Map<String, dynamic>> doc) {
    return JobOrderModel.fromMap(doc.data()!, doc.id);
  }
  ...
  /// Converts to a Map for creating a new job order.
  Map<String, dynamic> toCreateMap() {
    return toMap(forCreate: true);
  }

  /// Converts to a Map for updating a job order.
  ...
  factory JobOrderModel.fromEntity(JobOrderEntity entity) {
    return JobOrderModel(
      id: entity.id,
      name: entity.name,
      items:
  ...
  /// Creates an empty job order model.
  factory JobOrderModel.empty() {
    return JobOrderModel(
      id: '',
      name: '',
      items: [],
  ...
  /// Creates a new job order with default values.
  factory JobOrderModel.create({
  ...
  @override
  String toString() {
    return 'JobOrderModel(id: $id, name: $name, items: ${items.length}, total: $grandTotal)';
  }
}
