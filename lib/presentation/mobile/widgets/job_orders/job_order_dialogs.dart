...
/// Destructive "Delete job order?" confirm, built on the shared [AppDialog] shell.
///
/// Red leading chip (`trash-2`) + a recessed preview box showing the job order's
...
Future<void> showDeleteJobOrderDialog(
  ...
  final confirmed = await showDialog<bool>(
    ...
    builder: (ctx) {
      ...
      final mutedFill =
          dark ? AppColors.darkCanvas : AppColors.lightSurfaceMuted;
      ...
      return AppDialog(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Total ${jobOrder.grandTotal.toCurrency()}',
        ...
        actions: [
          ...
          appDialogPrimary(ctx, 'Delete',
              color: AppColors.error, onTap: () => Navigator.of(ctx).pop(true)),
        ],
      );
    },
  );
