...
function product(over: Partial<Product> = {}): Product {
  return {
    ...
    barcodes: [], sellingOptions: [], supplierId: null, supplierName: null, baseSku: null, variationNumber: null,
    isActive: true, imageUrl: null, notes: null, tagIds: [], searchKeywords: [], createdAt: new Date(),
